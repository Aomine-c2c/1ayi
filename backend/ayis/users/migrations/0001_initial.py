    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_system', models.BooleanField(default=False, help_text='System roles (admin, officer) cannot be deleted by regular users.')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('farmer', 'Farmer'), ('officer', 'Agricultural Officer'), ('admin', 'Administrator')], default='farmer', help_text='User role determining access scope.', max_length=10)),
